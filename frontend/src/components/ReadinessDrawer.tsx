                  ...
                  {[
                    {
                      ...
                      provider: readiness.providers.diagnose_llm,
                      ok: readiness.capabilities.diagnose_llm_configured,
                      icon: Cpu,
                      desc: 'DIAGNOSE stage root-cause classifier',
                    },
                    {
                      name: 'Razorpay Test Gateway',
                      provider: readiness.providers.payment,
                      ok: readiness.capabilities.payment_provider_configured,
                      icon: Key,
                      desc: 'DETECT webhook & order links',
                    },
                    {
                      name: 'Twilio WhatsApp Sandbox',
                      provider: readiness.providers.messaging,
                      ok: readiness.capabilities.messaging_configured,
                      icon: MessageSquare,
                    ...
                    },
                    {
                      ...
                      ok: readiness.capabilities.postgres_configured,
                      icon: Database,
